...
values
  (
    ...
    $$[
      ...
      {"title":"平台运营","links":[
        {"label":"促销活动","href":"/admin/promotions","icon":"local_offer"},
        {"label":"用户管理","href":"/admin/users","icon":"group"},
        {"label":"交易记录","href":"/admin/transactions","icon":"payments"},
  ...
  (
    ...
    $$[
      ...
      {"href":"/admin/promotions","icon":"campaign","title":"促销活动","desc":"优惠券、满减、投放时间窗"},
      {"href":"/admin/reports","icon":"monitoring","title":"报表中心","desc":"渠道对比、门店表现、趋势分析"}
    ]$$::jsonb
  ),
  (
    'admin_delivery_module_cards',
    $$[
      {"title":"类目管理","href":"/admin/delivery/menu/categories","icon":"category","desc":"类目排序、状态、营业时段"},
      {"title":"单品管理","href":"/admin/delivery/menu/items","icon":"list_alt","desc":"商品信息、库存、价格、标签"},
      {"title":"套餐管理","href":"/admin/delivery/menu/combos","icon":"inventory_2","desc":"套餐组件、必选/可选加购"},
      {"title":"Option Groups","href":"/admin/delivery/menu/option-groups","icon":"tune","desc":"规格组、加料组、选项加价"}
    ]$$::jsonb
  )
